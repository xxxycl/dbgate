...
<HorizontalSplitter>
  <div class="container" slot="1">
    <WidgetTitle>{_t('runnerOutputPane.messages', { defaultMessage: 'Messages' })}</WidgetTitle>
    <SocketMessageView
  ...
  <div class="container" slot="2">
    <WidgetTitle>{_t('runnerOutputPane.outputFiles', { defaultMessage: 'Output files' })}</WidgetTitle>
