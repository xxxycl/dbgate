...
<div class="main">
  <div class="flex">
    ...
    {:else}
      <UploadButton />
    {/if}
    <FormStyledButton value={_t('filesInput.addWebUrl', { defaultMessage: 'Add web URL' })} on:click={handleAddUrl} />
  </div>

  <div class="wrapper">{_t('filesInput.dragDropFiles', { defaultMessage: 'Drag & drop imported files here' })}</div>
</div>
